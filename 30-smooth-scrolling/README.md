...
In this experiment, we'll take Experiment 26 and do smooth scrolling instead
of tile scrolling. We also draw a rect on the tile where the avatar is located
so you can see collision detection.

![Experiment 30 - Smooth Scrolling Tiles](experiment.png)
