...
In this experiment, we'll mutate the animated sprite so it's using tile-based
movement instead of smooth movement.

![Experiment 24 - Tile Movement](experiment.png)
